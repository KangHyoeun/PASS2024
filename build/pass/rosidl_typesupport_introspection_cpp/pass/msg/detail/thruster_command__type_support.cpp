...
{
  new (message_memory) pass::msg::ThrusterCommand(_init);
}

void ThrusterCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<pass::msg::ThrusterCommand *>(message_memory);
  typed_message->~ThrusterCommand();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ThrusterCommand_message_member_array[4] = {
  {
    "delta_p",  // name
    ...
    offsetof(pass::msg::ThrusterCommand, delta_p),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pass::msg::ThrusterCommand, delta_s),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pass::msg::ThrusterCommand, rps_p),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(pass::msg::ThrusterCommand, rps_s),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ThrusterCommand_message_members = {
  "pass::msg",  // message namespace
  "ThrusterCommand",  // message name
  4,  // number of fields
  sizeof(pass::msg::ThrusterCommand),
...
{
  return &::pass::msg::rosidl_typesupport_introspection_cpp::ThrusterCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pass, msg, ThrusterCommand)() {
  return &::pass::msg::rosidl_typesupport_introspection_cpp::ThrusterCommand_message_type_support_handle;
}
